...
insert into media (mediaTitle, mediaYear, mediaCategory, mediaCost, mediaType, mediaQuantity, mediaPublisher, mediaCode, bookEdition, bookVolume, runningTime, movieDirector) 
...
insert into income (patronId, date, type, amountPaid) values(1, current_date()-1, "g", 55.00);
insert into income (patronId, date, type, amountPaid) values(4, current_date()-1, "g", 515.00);
