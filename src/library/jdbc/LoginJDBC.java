...
public class LoginJDBC {
    ...
    /**
     * Inserts an Staff account's login credentials. This method should only be
     * used when it is a new account being created. The default username will be
     * in the following format: username = lastName+ID password = last 4 digits
     * of registered phone number
     *
    ...
    /**
     * Inserts a Patron account's login credentials. This method should only be
     * used when it is a new account being created. The default username will be
     * in the following format: username = lastName+ID password = last 4 digits
     * of registered phone number
     *
